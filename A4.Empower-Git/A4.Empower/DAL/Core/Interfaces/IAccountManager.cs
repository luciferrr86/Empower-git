...
namespace DAL.Core.Interfaces
{
    public interface IAccountManager
    {
        ...
        Task<Tuple<bool, string[]>> AssignRolesToUser(string id, IEnumerable<string> rolesToAssign);
        ...
        Task<Tuple<List<ApplicationRole>,int>> GetRolesLoadRelatedAsync(int page, int pageSize,string name);
        Task<Tuple<ApplicationUser, string[]>> GetUserAndRolesAsync(string userId);
        Task<ApplicationUser> GetUserByEmailAsync(string email);
        Task<ApplicationUser> GetUserByIdAsync(string userId);
        Task<ApplicationUser> GetUserByUserNameAsync(string userName);
        Task<IList<string>> GetUserRolesAsync(ApplicationUser user);
        Task<List<Tuple<ApplicationUser, string[],int>>> GetUsersAndRolesAsync(int page, int pageSize,string name);
