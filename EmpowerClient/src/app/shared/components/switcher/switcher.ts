...
@Component({
    ...
    standalone: true,
    imports: [ColorPickerDirective,NgbModule],
})
export class Switcher  {
    ...
    updateTheme(theme: string) {
      ...
      if (theme == 'light') {
        this.appStateService.updateState({ theme, themeBackground: '', headerColor: 'transparent', menuColor: 'transparent' });
    ...
    updatemenuType(navigationStyles: string) {
      ...
      if (navigationStyles == 'horizontal') {
        ...
        this.appStateService.updateState({ navigationStyles, menuStyles: '', layoutStyles: 'doublemenu' });
  ...
  private checkMenuElement(menuStyles: string) {
    ...
    updatemenuColor(menuColor: string) {
      this.appStateService.updateState({ menuColor:menuColor });
    }
