...
import {MenuItems,CandidateMenuItems} from '../../shared/menu-items/menu-items';
...
/*  @ViewChild('toggleButton') toggle_button: ElementRef;
  ...
  constructor(public route:Router,public menuItems: CandidateMenuItems,  private authService: AuthService,     public router: Router) {
    this.navType = 'st2';
