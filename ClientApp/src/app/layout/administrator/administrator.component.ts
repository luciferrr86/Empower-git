import { Component, OnInit, trigger, state, style, AUTO_STYLE, transition, animate, ViewChild, ElementRef } from '@angular/core';
...
export class AdministratorComponent implements OnInit {
  ...
  constructor(public route: Router, public menuItems: AdministatorMenuItems, private authService: AuthService, public router: Router) {
    this.navType = 'st2';
