export class JobQualification {
    constructor(id?: string, hdPassingYear?: string, hdPercentage?: string, hdSpecialization?: string, higherDegreeInstitue?: string, highestQualification?: string
        , sdPassingYear?: string, sdPercentage?: string, sdSpecialization?: string, secondaryInstitue?: string, secondaryQualification?: string
        ...
        this.secondaryInstitue = secondaryInstitue;
    ...
    public secondaryInstitue: string;
