...
export class AccountService {
    ...
    getUsers(page?: number, pageSize?: number) {
        ...
        return this.accountEndpoint.getUsersEndpoint<any>(page, pageSize);
    }

    getUsersAndRoles(page?: number, pageSize?: number, name?: string) {
        return Observable.forkJoin(
            this.accountEndpoint.getUsersEndpoint<any>(page, pageSize, name),
            this.accountEndpoint.getRolesEndpoint<any>(-1, -1));
    }
  ...
  updateUser(user: UserEdit) {
    ...
    newUser(user: UserEdit) {
        return this.accountEndpoint.getNewUserEndpoint<string>(user);
    }
    ...
    getRoles(page?: number, pageSize?: number) {
        ...
        return this.accountEndpoint.getRolesEndpoint<any>(page, pageSize);
    }


    getRolesAndPermissions(page?: number, pageSize?: number, name?: string) {

        return Observable.forkJoin(
            this.accountEndpoint.getRolesEndpoint<any>(page, pageSize, name),
    ...
    newRole(role: Role) {
        return this.accountEndpoint.getNewRoleEndpoint<string>(role)
