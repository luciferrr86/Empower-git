...
@Component({
  selector: 'hr-employee-leave-info',
  templateUrl: './hr-employee-leave-info.component.html',
  styleUrls: ['./hr-employee-leave-info.component.css']
})
export class HrEmployeeLeaveInfoComponent implements OnInit {
