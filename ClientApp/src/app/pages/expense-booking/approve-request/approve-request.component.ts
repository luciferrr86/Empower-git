...
export class ApproveRequestComponent implements OnInit {
  ...
  getApproveRequest(page?: number, pageSize?: number, name?: string) {
    this.expenseBookingService.getApproveList(this.accountService.currentUser.id, page, pageSize, name).subscribe(result => this.onSuccessfulDataLoad(result), error => this.onDataLoadFailed(error));
  }
  ...
  getApprovedExcelManager() {
    this.expenseBookingService.getApprovedExcelManager(this.accountService.currentUser.id).subscribe(result => this.onSuccessfulDataLoadExcel(result), error => this.onDataLoadFailedExcel(error));
  }
